...
The real queries carry more than this, cache lifetimes, skip conditions, and the derived-data keys that [Part 4](/blog/tanstack-query-derived-state-performance) leans on, but the shape is always this: one object per resource. Components never touch it directly. They call a thin hook, and the hook hands back exactly the async state Redux made us track by hand:
