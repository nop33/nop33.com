...
- A new transaction hash triggers an ordered invalidation cascade. Every balance and token query uses `staleTime: Infinity`. Freshness is event-driven, not time-driven.
