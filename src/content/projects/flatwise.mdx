  ...
  <div class="container my-60">
    <div class="grid grid-cols-1 gap-24 md:grid-cols-[1fr_2fr] items-center">
      ...
      <div class="space-content flex flex-col justify-center">
        ...
        _Treat furniture as a depreciating shared asset_
...
<div>
  <div class="my-60 space-content">
    ...
    I built the app from scratch using Vue.js, deliberately choosing a framework I had only scratched the surface of while working at Station AG in Zurich.
...
<div>
  <div class="my-60 space-content">
    ...
    Instead, this project helped me extend and deepen those foundations in a new technical context. Itforced me to learn:
