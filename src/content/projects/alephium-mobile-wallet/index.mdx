...
<div>
  <div class="my-12 grid grid-cols-2 gap-2 md:my-20 md:grid-cols-2 md:gap-12">
    <div class="flex flex-col gap-6 md:gap-12">
      <Media src={imgMobileWallet1} class="mx-auto max-w-[280px] md:max-w-none" />
      <Media src={imgMobileWallet4} class="mx-auto max-w-[280px] md:max-w-none" />
    </div>
    <div class="mt-62 flex flex-col gap-6 md:gap-12">
      <Media src={imgMobileWallet3} class="mx-auto max-w-[280px] md:max-w-none" />
      <Media src={imgMobileWallet2} class="mx-auto max-w-[280px] md:max-w-none" />
    </div>
  </div>
</div>
