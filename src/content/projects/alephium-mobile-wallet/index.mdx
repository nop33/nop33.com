...
featuredImage2: ./260shots_so.png
...
import imgMobileWallet1 from './mobile-wallet-1.png'
import imgMobileWallet2 from './mobile-wallet-2.png'
import imgMobileWallet3 from './mobile-wallet-3.png'
import imgMobileWallet4 from './mobile-wallet-4.png'
...
<div>
  <div class="my-12 grid grid-cols-2 gap-2 md:my-20 md:grid-cols-2 md:gap-12">
    <div class="flex flex-col gap-6 md:gap-12">
      <Media src={imgMobileWallet1.src} class="mx-auto max-w-[280px] md:max-w-none" ratio="auto" />
      <Media src={imgMobileWallet4.src} class="mx-auto max-w-[280px] md:max-w-none" ratio="auto" />
    </div>
    <div class="mt-62 flex flex-col gap-6 md:gap-12">
      <Media src={imgMobileWallet3.src} class="mx-auto max-w-[280px] md:max-w-none" ratio="auto" />
      <Media src={imgMobileWallet2.src} class="mx-auto max-w-[280px] md:max-w-none" ratio="auto" />
    </div>
  </div>
</div>
