...
<BreakoutSection>
  <div class="container my-20 md:my-32">
    <div class="grid grid-cols-1 gap-24 md:grid-cols-[1fr_2fr] items-center">
      <Media src={imgBalances} class="max-w-[280px] w-full h-auto mx-auto md:mx-0" />
...
<div>
  <div class="my-20 flex flex-col items-center justify-center gap-24 sm:flex-row sm:gap-2 md:my-32">
    <Media src={imgItem} class="mx-auto h-auto w-full max-w-[280px] md:mx-0" />
    <Media src={imgMoveout} class="mx-auto h-auto w-full max-w-[280px] md:mx-0" />
  </div>
</div>
