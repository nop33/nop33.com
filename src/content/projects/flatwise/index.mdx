...
featuredImage2: ./flatwise-iphone-left.png
tags: ['Web', 'Open-source', 'Vue.js']
...
import imgBalances from './flatwise-iphone-balances-portrait.png'
import imgFirebase from './flatwise-firebase.png'
import imgItem from './flatwise-item.png'
import imgMoveout from './flatwise-moveout.png'
...
<div>
  <div class="my-20 flex flex-col items-center justify-center gap-24 sm:flex-row sm:gap-2 md:my-32">
    <Media src={imgItem.src} class="mx-auto h-auto w-full max-w-[280px] md:mx-0" ratio="auto" />
    <Media src={imgMoveout.src} class="mx-auto h-auto w-full max-w-[280px] md:mx-0" ratio="auto" />
  </div>
</div>
