...
I worked on the wallet as a core frontend engineer, contributing both to product features and to foundational architectural decisions together with my colleague [Mikael Vraivre](https://x.com/mikalph). Over time, the project evolved from a relatively simple Electron app into a highly modular, performance-sensitive system that balances UX, security, and scalability.
